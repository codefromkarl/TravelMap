...
- Name: page-startup.spec.ts >> L1 — JS 模块加载与初始化 >> ChatPanel 组件渲染完成（shadowRoot 已挂载）
- Location: web/__tests__/page-startup.spec.ts:229:3
...
Call log:
  - waiting for locator('#loading') to be hidden
    61 × locator resolved to visible <div id="loading">正在初始化...</div>
