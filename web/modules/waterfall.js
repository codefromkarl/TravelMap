...
import { getWaterfallData, getTraceSummary, getRecentTraceIds } from './perf-trace.js?v=7';
import { getLogEntries } from './logger.js?v=7';
...
function exportPanelData() {
  ...
  // 动态导入避免循环依赖
  import('./perf-trace.js?v=7').then(({ exportTraceData }) => {
