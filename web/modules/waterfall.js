...
import { getWaterfallData, getTraceSummary, getRecentTraceIds } from './perf-trace.js?v=6';
import { getLogEntries } from './logger.js?v=6';
...
function exportPanelData() {
  ...
  // 动态导入避免循环依赖
  import('./perf-trace.js?v=6').then(({ exportTraceData }) => {
