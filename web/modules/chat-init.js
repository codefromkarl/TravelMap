...
import { config, resolveApiKey } from './config.js?v=7';
import {
...
import { feedback } from './feedback.js?v=7';
import { appState } from './app-state.js?v=7';
import { speak, pause, resume, stop, getState, isTTSSupported, generateSpeechText } from './tts.js?v=7';
import { initRecognition, startListening, stopListening, getSTTState, isSTTSupported } from './stt.js?v=7';
import { ALL_TOOLS } from './tools/index.js?v=7';
import { buildSystemPrompt } from './prompt.js?v=7';
import { initWelcome } from './welcome.js?v=7';
import { initPageMap } from './map.js?v=7';
import { initPlaceholder, applyI18n } from './i18n.js?v=7';
import { tryRestoreSession } from './session.js?v=7';
import { initTravelersPanel } from './travelers.js?v=7';
import { loadSharedTrip, renderSharedTrips } from './export.js?v=7';
import { loadSharedTripFromHash } from './share.js?v=7';
import { saveTripPlan, listTrips, migrateCoordinatesToGcj02 } from './db.js?v=7';
import { addTraceHeaders, extractTraceId } from './trace.js?v=7';
...
export async function initApp() {
  ...
  const panelModule = await import('./panels.js?v=7');
  ...
  if (btnPoster) {
    btnPoster.addEventListener('click', async () => {
      ...
      try {
        // 动态导入 share 模块
        const { generateTripPoster, downloadImage } = await import('./share.js?v=7');
  ...
  if (btnCompanion) {
    // 动态导入语音伴游模块
    import('./voice-companion.js?v=7').then(({ startVoiceCompanion, stopVoiceCompanion, getCompanionState, setTripPlanForCompanion }) => {
