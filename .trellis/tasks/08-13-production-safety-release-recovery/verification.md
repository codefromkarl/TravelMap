...
| 最终发布/BASE_URL/workflow/artifact 与路径修复回归 | 4 files，50/50 通过 |
...
| 真实 artifact build + independent validate | 通过；96 files，11,532,083 bytes，SHA-256 `56cb952d5cd0b11b47949d047b7acb0afff419f81315b39ebc65af07ef08e6fe` |
...
- Wrangler 由 lockfile 精确固定为 `4.122.0`，真实 Functions build 成功。
