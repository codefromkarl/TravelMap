...
- Keep the startup skeleton above guest controls until the chat auth gate and deferred map prompt listeners are installed; visible guest actions must already be interactive.
