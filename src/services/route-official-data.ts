        ...
        riskFactors: [
          {
            type: "distance",
            level: "medium",
            description: "环湖全程约10公里，步行时间较长，建议穿舒适鞋子",
          },
        ],
        suitability: {
          seniors: "suitable",
        ...
        riskFactors: [
          {
            type: "terrain",
            level: "low",
            description: "龙井村至九溪段有缓坡，雨天路面湿滑",
            affectedWaypoints: [3, 4],
          },
          {
            type: "isolation",
            level: "medium",
            description: "茅家埠段远离人群，手机信号可能不稳定",
            affectedWaypoints: [2],
          },
        ],
        suitability: {
        ...
        riskFactors: [
          {
            type: "steps",
            level: "low",
            description: "雷峰塔需登塔（约4层楼梯），带婴儿车需留意",
            affectedWaypoints: [1],
          },
        ],
        suitability: {
        ...
        riskFactors: [
          {
            type: "distance",
            level: "low",
            description: "中轴线全程约2公里，对体力要求低，但全程无遮阴，夏季注意防晒",
          },
          {
            type: "isolation",
            level: "low",
            description: "故宫内部无餐饮，仅有少量商店，请自备补给",
          },
        ],
        suitability: {
          seniors: "suitable",
        ...
        riskFactors: [
          {
            type: "distance",
            level: "medium",
            description: "路线较长，覆盖中轴线+东六宫，总步行约3公里",
          },
        ],
        suitability: {
          seniors: "suitable",
        ...
        riskFactors: [
          {
            type: "elevation",
            level: "medium",
            description: "佛香阁需登万寿山，累计爬升约65米，台阶较多",
            affectedWaypoints: [3, 4],
          },
          {
            type: "steps",
            level: "medium",
            description: "排云殿至佛香阁为连续台阶，对膝关节有一定压力",
            affectedWaypoints: [3, 4],
          },
        ],
        suitability: {
          ...
          children: "suitable",
          pregnant: "caution",
          mobilityImpaired: "not_recommended",
        },
      },
    },
  ],
...
const HUANGSHAN_ROUTES: OfficialRouteData = {
  names: ["黄山", "黄山风景区"],
  city: "黄山",
  routes: [
    {
      ...
      name: "黄山经典后山路线（云谷寺上）",
      description:
        "后山云谷寺索道上，经始信峰、北海、光明顶，前山玉屏索道下。经典一日游，覆盖黄山精华",
      duration: 480,
      waypoints: [
        {
          name: "云谷寺",
          location: { latitude: 30.138, longitude: 118.173 },
          elevation: 890,
          terrainType: "paved",
          visitDuration: 20,
          isOptional: false,
          description: "后山入口，可乘索道或徒步上山",
          supplyPoints: [
            {
              name: "云谷寺商店",
              type: "shop",
              description: "饮料、登山杖、雨衣",
              estimatedCost: 30,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "白鹅岭",
          location: { latitude: 30.141, longitude: 118.168 },
          elevation: 1760,
          terrainType: "trail",
          visitDuration: 30,
          isOptional: false,
          description: "云海观赏点，视野开阔",
          supplyPoints: [],
        },
        {
          name: "始信峰",
          location: { latitude: 30.143, longitude: 118.165 },
          elevation: 1683,
          terrainType: "stairs",
          visitDuration: 40,
          isOptional: false,
          description: "黄山最美山峰之一，「始信黄山天下奇」",
          supplyPoints: [],
        },
        {
          name: "北海宾馆",
          location: { latitude: 30.146, longitude: 118.162 },
          elevation: 1630,
          terrainType: "paved",
          visitDuration: 20,
          isOptional: false,
          description: "北海景区中心，可休息补给",
          supplyPoints: [
            {
              name: "北海宾馆小卖部",
              type: "shop",
              description: "饮料、方便面、热食",
              estimatedCost: 35,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "光明顶",
          location: { latitude: 30.131, longitude: 118.168 },
          elevation: 1860,
          terrainType: "trail",
          visitDuration: 40,
          isOptional: false,
          description: "黄山第二高峰，360°观景平台",
          supplyPoints: [
            {
              name: "光明顶山庄小卖部",
              type: "shop",
              description: "饮料、简单热食，价格较高",
              estimatedCost: 40,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "鳌鱼峰",
          location: { latitude: 30.129, longitude: 118.165 },
          elevation: 1780,
          terrainType: "stairs",
          visitDuration: 30,
          isOptional: false,
          description: "形似鳌鱼，登顶俯瞰西海",
          supplyPoints: [],
        },
        {
          name: "百步云梯",
          location: { latitude: 30.127, longitude: 118.162 },
          elevation: 1710,
          terrainType: "stairs",
          visitDuration: 20,
          isOptional: false,
          description: "218级陡峭台阶，黄山最险路段之一",
          supplyPoints: [],
        },
        {
          name: "玉屏楼（迎客松）",
          location: { latitude: 30.125, longitude: 118.159 },
          elevation: 1680,
          terrainType: "paved",
          visitDuration: 30,
          isOptional: false,
          description: "黄山标志迎客松，前山核心景点",
          supplyPoints: [
            {
              name: "玉屏楼宾馆小卖部",
              type: "shop",
      ...
      tags: ["经典", "索道", "全景"],
      source: "official",
      sourceMeta: { url: "https://www.intohuangshan.com.cn" },
      difficulty: 3,
      supplyStrategy: {
        waterStations: 3,
        restAreas: 2,
        recommendedBreaks: [
          {
            ...
            duration: 20,
            location: "北海宾馆",
            availableSupply: "小卖部（饮料¥15、热食¥35）",
          },
          {
            afterWaypointIndex: 4,
            duration: 30,
            location: "光明顶",
            availableSupply: "光明顶山庄小卖部",
          },
        ],
        warnings: [
          "山顶补给点稀少且价格较高，建议自带2L以上饮水和高热量食物",
          "始信峰至光明顶段海拔落差大，气温比山下低10-15℃，需备防风外套",
        ],
      },
      riskAssessment: {
        riskLevel: 3,
        totalElevationGain: 970,
        totalElevationLoss: 180,
        maxElevation: 1860,
        minElevation: 890,
        ...
        riskFactors: [
          {
            type: "elevation",
            level: "high",
            description: "累计爬升近1000米（若全程徒步则达1500米以上），高海拔对心肺功能要求高",
            affectedWaypoints: [0, 1, 2, 4],
          },
          {
            type: "terrain",
            level: "high",
            description: "百步云梯等路段为陡峭石阶，两侧为悬崖，恐高者慎行",
            affectedWaypoints: [5, 6],
          },
          {
            type: "weather",
            level: "high",
            description: "山顶天气多变，突遇雷暴/大风时暴露地段风险极高",
          },
          {
            type: "isolation",
            level: "medium",
            description: "始信峰至鳌鱼峰段沿途补给极少，如遇体力不支救援困难",
            affectedWaypoints: [2, 3, 4, 5],
          },
        ],
        suitability: {
          seniors: "not_recommended",
          children: "caution",
          pregnant: "not_recommended",
          mobilityImpaired: "not_recommended",
        },
      },
    },
    {
      id: "huangshan_westsea",
      name: "黄山西海大峡谷深度游",
      description:
        "从排云亭下西海大峡谷，经一环二环至谷底，再乘地轨缆车上。峡谷深切，栈道险峻，景观震撼",
      duration: 360,
      waypoints: [
        {
          name: "排云亭",
          location: { latitude: 30.145, longitude: 118.158 },
          elevation: 1590,
          terrainType: "paved",
          visitDuration: 20,
          isOptional: false,
          description: "西海大峡谷入口，观云海绝佳处",
          supplyPoints: [],
        },
        {
          name: "一环（外环）",
          location: { latitude: 30.143, longitude: 118.155 },
          elevation: 1400,
          terrainType: "trail",
          visitDuration: 40,
          isOptional: false,
          description: "沿崖壁栈道下行，景色险峻",
          supplyPoints: [],
        },
        {
          name: "二环（内环）",
          location: { latitude: 30.141, longitude: 118.153 },
          elevation: 1200,
          terrainType: "stairs",
          visitDuration: 50,
          isOptional: false,
          description: "更陡峭的栈道，谷底近在咫尺",
          supplyPoints: [],
        },
        {
          name: "谷底",
          location: { latitude: 30.138, longitude: 118.152 },
          elevation: 900,
          terrainType: "paved",
          visitDuration: 20,
          isOptional: false,
          description: "大峡谷最低点，仰望千仞绝壁",
          supplyPoints: [
            {
              name: "谷底小卖部",
              type: "shop",
              description: "饮料、零食，价格较贵",
              estimatedCost: 35,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "地轨缆车上站（天海）",
          location: { latitude: 30.131, longitude: 118.156 },
          elevation: 1650,
          terrainType: "paved",
          visitDuration: 15,
          isOptional: false,
          description: "乘地轨缆车返回山顶",
          supplyPoints: [],
        },
      ],
      tags: ["深度", "峡谷", "栈道"],
        ...
        recommendedBreaks: [
          {
            ...
            duration: 20,
            location: "谷底",
            availableSupply: "谷底小卖部",
          },
        ],
        warnings: [
          "西海大峡谷全程约4公里下坡栈道，对膝盖压力极大，建议带护膝",
          "峡谷内手机信号弱，结伴而行，不建议独自进入",
        ],
      },
      riskAssessment: {
        riskLevel: 3,
        totalElevationGain: 60,
        totalElevationLoss: 690,
        maxElevation: 1590,
        minElevation: 900,
        estimatedCalories: 680,
        estimatedSteps: 14000,
        riskFactors: [
          {
            type: "elevation",
            level: "high",
            description: "从1590米降至900米再升至1650米，全程大落差，膝关节压力极大",
            affectedWaypoints: [0, 1, 2, 3],
          },
          {
            type: "terrain",
            level: "high",
            description: "一环二环为悬空栈道，最窄处仅容一人，外侧为深渊",
            affectedWaypoints: [1, 2],
          },
          {
            type: "exposure",
            level: "high",
            description: "谷底至缆车段几乎无遮挡，夏季暴晒、冬季严寒",
          },
          {
            type: "isolation",
            level: "high",
            description: "峡谷中段手机无信号，如遇意外难以呼救",
            affectedWaypoints: [1, 2],
          },
        ],
        suitability: {
          seniors: "not_recommended",
          children: "not_recommended",
          pregnant: "not_recommended",
          mobilityImpaired: "not_recommended",
        },
      },
...
const TAISHAN_ROUTES: OfficialRouteData = {
  names: ["泰山", "泰山风景区"],
  city: "泰安",
  routes: [
    {
      ...
      name: "泰山红门经典登山路线",
      description:
        "最经典的徒步登山路线，从红门经中天门、十八盘至南天门，全程约6366级台阶，挑战体力极限",
      duration: 420,
      waypoints: [
        {
          name: "红门",
          location: { latitude: 36.207, longitude: 117.113 },
          elevation: 250,
          terrainType: "paved",
          visitDuration: 10,
          isOptional: false,
          description: "传统登山起点，岱庙方向",
          supplyPoints: [
            {
              name: "红门商店",
              type: "shop",
              description: "登山杖、手套、饮料",
              estimatedCost: 20,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "万仙楼",
          location: { latitude: 36.21, longitude: 117.115 },
          elevation: 340,
          terrainType: "stairs",
          visitDuration: 15,
          isOptional: false,
          description: "购票处，开始正式登山",
          supplyPoints: [],
        },
        {
          name: "中天门",
          location: { latitude: 36.225, longitude: 117.118 },
          elevation: 800,
          terrainType: "paved",
          visitDuration: 30,
          isOptional: false,
          description: "半程休息点，可换乘索道",
          supplyPoints: [
            {
              name: "中天门餐饮区",
              type: "restaurant",
              description: "面条、炒菜、饮料",
              estimatedCost: 50,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "十八盘",
          location: { latitude: 36.238, longitude: 117.12 },
          elevation: 1200,
          terrainType: "stairs",
          visitDuration: 60,
          isOptional: false,
          description: "泰山最险峻路段，1600余级陡峭台阶",
          supplyPoints: [
            {
              name: "十八盘休息点",
              type: "rest_area",
              description: "少量长椅，可短暂休息",
              estimatedCost: 0,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "南天门",
          location: { latitude: 36.251, longitude: 117.122 },
          elevation: 1460,
          terrainType: "paved",
          visitDuration: 20,
          isOptional: false,
          description: "登山终点象征，天门回望",
          supplyPoints: [
            {
              name: "南天门商店",
              type: "shop",
              description: "饮料、热食、租军大衣",
              estimatedCost: 40,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "天街",
          location: { latitude: 36.253, longitude: 117.123 },
          elevation: 1480,
          terrainType: "paved",
          visitDuration: 20,
          isOptional: false,
          description: "山顶商业街，可休整补给",
          supplyPoints: [
            {
              name: "天街餐饮",
              type: "restaurant",
              description: "面条、炒菜，价格较高",
              estimatedCost: 60,
              locationAccuracy: "unknown",
              priceConfidence: "estimate",
              lastUpdated: "2025-05-18",
        ...
        {
          name: "玉皇顶",
          location: { latitude: 36.256, longitude: 117.124 },
          elevation: 1545,
          terrainType: "slope",
          visitDuration: 30,
          isOptional: false,
          description: "泰山极顶，五岳独尊石碑",
          supplyPoints: [],
        },
      ],
      tags: ["经典", "登山", "挑战"],
      source: "official",
      sourceMeta: { url: "https://tsgw.taian.gov.cn" },
      difficulty: 3,
      supplyStrategy: {
        waterStations: 3,
        restAreas: 2,
        recommendedBreaks: [
          {
            ...
            duration: 30,
            location: "中天门",
            availableSupply: "中天门餐饮区（面食¥30-50）",
          },
          {
            afterWaypointIndex: 3,
            duration: 15,
            location: "十八盘休息点",
            availableSupply: "短暂休整，无商业补给",
          },
        ],
        warnings: [
          "十八盘全程1600余级台阶，坡度达70-80度，体力消耗极大，建议在中天门充分休息",
          "山顶夜间温度比山下低15-20℃，夜爬看日出务必带厚外套或租军大衣",
          "全程6366级台阶，对膝关节冲击大，建议携带登山杖、护膝",
        ],
      },
      riskAssessment: {
        riskLevel: 3,
        totalElevationGain: 1295,
        totalElevationLoss: 0,
        maxElevation: 1545,
        minElevation: 250,
        estimatedCalories: 1200,
        estimatedSteps: 22000,
        riskFactors: [
          {
            type: "elevation",
            level: "high",
            description: "累计爬升1295米，全程6366级台阶，对心肺功能和下肢力量要求极高",
            affectedWaypoints: [0, 1, 2, 3, 4],
          },
          {
            type: "terrain",
            level: "high",
            description: "十八盘为连续陡峭石阶，最陡处近80度，需手脚并用",
            affectedWaypoints: [3],
          },
          {
            type: "weather",
            level: "high",
            description: "山顶气温低、风力大，突遇雨雪时台阶湿滑极易摔倒",
          },
          {
            type: "steps",
            level: "high",
            description: "全程6366级台阶，膝关节持续承压，下山时损伤尤甚",
          },
        ],
        suitability: {
          seniors: "not_recommended",
    ...
    },
    {
      ...
      name: "泰山天外村轻松路线",
      description:
        "从天外村乘景区大巴至中天门，再乘索道到南天门，最后步行至玉皇顶。适合时间有限或体力一般的游客",
      duration: 240,
      waypoints: [
        {
          name: "天外村",
          location: { latitude: 36.198, longitude: 117.105 },
          elevation: 220,
          terrainType: "paved",
          visitDuration: 10,
          isOptional: false,
          description: "乘车入口，可乘大巴直达中天门",
          supplyPoints: [
            {
              name: "天外村商店",
              type: "shop",
        ...
        recommendedBreaks: [
          {
            ...
            duration: 15,
            location: "中天门",
            availableSupply: "商店（饮料¥10-20）",
          },
        ],
        warnings: ["索道遇大风可能停运，建议出发前关注天气"],
      },
      riskAssessment: {
        riskLevel: 1,
        ...
        riskFactors: [
          {
            type: "elevation",
            level: "low",
            description: "南天门至玉皇顶仍有约85米爬升，需步行台阶",
            affectedWaypoints: [2, 3, 4],
          },
          {
            type: "weather",
            level: "medium",
            description: "山顶气温比山下低10-15℃，即使夏季也需备外套",
          },
        ],
        suitability: {
          seniors: "suitable",
