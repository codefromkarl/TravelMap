...
const CITY_COORDS: Record<string, { latitude: number; longitude: number }> = {
  ...
  苏州: { latitude: 31.299, longitude: 120.5853 },
  ...
  哈尔滨: { latitude: 45.8038, longitude: 126.535 },
  ...
  拉萨: { latitude: 29.65, longitude: 91.1 },
  ...
  三亚: { latitude: 18.2528, longitude: 109.512 },
  珠海: { latitude: 22.271, longitude: 113.5767 },
  东莞: { latitude: 23.043, longitude: 113.7633 },
  ...
  温州: { latitude: 28.0, longitude: 120.6722 },
};
